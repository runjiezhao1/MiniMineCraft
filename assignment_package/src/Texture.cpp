...
{
    context->printGLErrorLog("In Texture::create() start,");
    //std::cout << "created here" << std::endl;
...
//    std::cout << img.isNull() << std::endl;
    ...
    context->printGLErrorLog("In Texture::create() end,");
}

void Texture::load(int texSlot = 0)
{
    context->printGLErrorLog("In Texture::load(), ");
