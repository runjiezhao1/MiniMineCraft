...
struct InputBundle {
    bool wPressed, aPressed, sPressed, dPressed, qPressed, ePressed,leftButton,rightButton;
    bool spacePressed;
    float mouseX, mouseY;

    InputBundle()
        : wPressed(false), aPressed(false), sPressed(false),qPressed(false),ePressed(false),leftButton(false),rightButton(false),
